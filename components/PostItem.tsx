...
({ post, currentUser, onUpvote, onViewProfile, onShare }) => {
    ...
    return (
        <div className="glass-card rounded-2xl p-6 transition-all duration-300 hover:border-gold/20 animate-fade-in group">
            <div className="flex gap-4">
                <button onClick={() => onViewProfile(post.authorId)} className="flex-shrink-0">
                     <div className="w-12 h-12 rounded-xl bg-obsidian border border-white/10 flex items-center justify-center overflow-hidden">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-4 text-gray-200 text-sm leading-relaxed wysiwyg-content font-medium opacity-90">
