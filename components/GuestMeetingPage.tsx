        ...
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-black font-sans text-center">
                <div className="module-frame glass-module p-10 sm:p-16 rounded-[4rem] border-red-500/20 shadow-premium max-w-md w-full relative">
                    ...
                    <p className="text-sm text-gray-400 leading-loose uppercase font-black tracking-widest opacity-60">
                        {protocolError}
                    </p>
                    <button 
                        onClick={() => window.location.href = '/'}
                        className="mt-10 w-full py-5 bg-white/5 border border-white/10 text-white font-black rounded-2xl uppercase tracking-widest text-[10px]"
                    >
                        Return to Portal
                    </button>
                </div>
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-black relative overflow-hidden font-sans">
            ...
            <div className="module-frame glass-module p-10 sm:p-16 rounded-[4rem] border-white/10 shadow-premium max-w-md w-full relative animate-fade-in text-center">
                ...
                <div className="space-y-1 mb-12">
                    ...
                    {meeting?.expiresAt && (
                        <p className="text-[7px] font-black text-gray-600 uppercase tracking-widest">
                            STIPULATED END: {meeting.expiresAt.toDate().toLocaleString()}
                        </p>
                    )}
                </div>
                ...
                <div className="mt-12 pt-10 border-t border-white/5 flex items-start gap-4 text-left">
                    <div className="p-2 bg-white/5 rounded-lg border border-white/10 text-gray-500 mt-1">
                        <ShieldCheckIcon className="h-5 w-5" />
                    </div>
                    <p className="text-[9px] text-gray-600 font-black uppercase tracking-widest leading-loose">
                        SECURE_PROTOCOL: This session is temporary. Media hardware is released immediately upon protocol termination. No data is logged.
                    </p>
                </div>
            </div>
