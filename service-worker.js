...
// This MUST be at the top of the file to work correctly.
self.importScripts('https://www.gstatic.com/firebasejs/10.12.5/firebase-app-compat.js');
self.importScripts('https://www.gstatic.com/firebasejs/10.12.5/firebase-messaging-compat.js');
...
messaging.onBackgroundMessage((payload) => {
  ...
  const notificationOptions = {
    ...
    // icon: '/icon-192.png' // Optional: Add an icon file to your public folder for notifications.
  };
