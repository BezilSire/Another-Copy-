...
export const AuthPage: React.FC = () => {
  ...
  const handleRecoveryComplete = async (m: string, p: string, data: any) => {
    try {
        ...
        addToast("Account Recovered.", "success");
        setView('login');
    } catch (err) {
                ...
                <div className="module-frame glass-module p-10 sm:p-16 rounded-[3rem] border-white/10 shadow-2xl flex flex-col items-center animate-fade-in max-w-md w-full relative overflow-hidden">
                    ...
                    <div className="flex flex-col gap-4 w-full relative z-10">
                        ...
                        <div className="mt-8 pt-8 border-t border-white/5 flex flex-col gap-4">
                            ...
                            <p className="text-[8px] text-gray-600 text-center uppercase font-bold tracking-widest px-4">
                    ...
                    <div className="mt-12 text-center pb-2 relative z-10 border-t border-white/5 pt-8 w-full">
                        <button onClick={() => setIsPolicyVisible(true)} className="text-[8px] font-black uppercase tracking-[0.6em] text-gray-700 hover:text-brand-gold transition-colors">Privacy & Rules</button>
                    </div>
                </div>
            );
        case 'recovery':
