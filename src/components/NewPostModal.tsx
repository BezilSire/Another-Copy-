          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            {postType === 'opportunity' && (
                <div className="animate-fade-in bg-slate-800/50 p-4 rounded-lg border border-slate-700">
                    <h4 className="text-sm font-semibold text-green-400 mb-2">Collaboration Matching</h4>
                    <p className="text-xs text-gray-400 mb-3">
                        Select the skills you are looking for. We will notify members who match these skills.
                    </p>
                    <MultiSelectPills
