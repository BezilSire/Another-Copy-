    ...
    return (
        <div className="module-frame glass-module p-8 sm:p-12 rounded-[3rem] border-brand-gold/20 shadow-premium animate-fade-in max-w-2xl w-full relative">
            ...
            <div className="flex flex-col items-center mb-10 text-center">
                <div className="w-20 h-20 bg-brand-gold/10 rounded-2xl flex items-center justify-center border border-brand-gold/20 mb-6 shadow-glow-gold">
                ...
                <h2 className="text-3xl font-black text-white uppercase tracking-tighter gold-text leading-none">
                    {step === 1 ? 'Genesis Anchor' : step === 2 ? 'Verify State' : 'Node Seal'}
                </h2>
                <p className="label-caps mt-3 !text-gray-500 !text-[8px] !tracking-[0.4em]">
                    {step === 1 ? 'Deriving 12-Word Identity' : step === 2 ? 'Provenance Verification' : 'Establishing Local Node Access'}
                </p>
            </div>
                ...
                <div className="space-y-8 animate-fade-in">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                        {isGenerating ? (
                            ...
                            <div key={i} className="bg-black/40 border border-white/5 p-4 rounded-xl flex items-center gap-4 group hover:border-brand-gold/30 transition-all">
            ...
            {step === 3 && (
                <div className="space-y-10 animate-fade-in max-w-sm mx-auto">
                    ...
                    <button onClick={handleNextStep} disabled={pin.length !== 6 || pin !== confirmPin} className="w-full py-6 bg-brand-gold text-slate-950 font-black rounded-3xl uppercase tracking-[0.3em] text-[11px] shadow-glow-gold active:scale-95 transition-all">
